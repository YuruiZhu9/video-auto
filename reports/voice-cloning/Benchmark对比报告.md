...
### Qwen3-TTS vs 商业竞品（来源：博客园 2026-02 技术报告）

| 指标 | Qwen3-TTS 1.7B | MiniMax | SeedTTS | ElevenLabs | OpenAI TTS |
|------|---------------|---------|---------|-----------|-----------|
| 中文 WER↓ | **2.12%** | 2.45% | 2.67% | — | — |
| 英文 WER↓ | **2.58%** | 2.83% | 2.91% | — | — |
| 说话人相似度↑ | **0.89** | 0.85 | 0.83 | — | — |
| TTFA 延迟 | **97ms** | 120ms | — | 150-300ms | 200-400ms |

> ↑=越高越好（说话人相似度）；↓=越低越好（WER）
> Qwen3-TTS 在中文WER/英文WER/说话人相似度三项指标上均超越 MiniMax 和 SeedTTS，且延迟最低

### SiliconFlow 平台 Top3 开源 TTS（2026-04 更新）

| 排名 | 模型 | TTS Arena ELO | 核心优势 | 价格 |
|------|------|-------------|---------|------|
| 🥇 1 | **Fish Speech V1.5** | 1339（最高）| 80+语言、DualAR架构 | $15/M |
| 🥈 2 | **CosyVoice2-0.5B** | — | 流式150ms、MOS 5.53 | $7.15/M |
| 🥉 3 | **IndexTTS-2** | — | 零样本克隆、精确时长控制 | $7.15/M |

> Fish Speech V1.5：英语 CER 1.2%，中文 CER 1.3%，质量最高但价格/速度较低
> CosyVoice2-0.5B：中文方言支持（粤语/四川话/上海话），方言场景首选
> IndexTTS-2：视频配音等需要精确时长控制的场景首选

...
> 🤖 免费语音克隆方案Agent | 2026-04-12 更新
> 模型来源：OpenBMB（面壁智能）| 发布时间：**2026年4月（VoxCPM2）**

---

## 一、模型概览

**VoxCPM2** 是 OpenBMB 团队于 **2026年4月** 发布的**Tokenizer-Free 文本转语音系统**，完全抛弃离散 Tokenizer 环节，直接在连续声学空间建模语音，实现高保真、自然流畅的零样本语音克隆。

**核心创新：** 连续空间端到端生成 → 彻底消除离散化误差 → 48kHz 工作室级音质

**GitHub 狂飙中：** 发布约1个月，Stars 从 0 飙升至 **9.9k**，日均增长 ~300+，为 2026 年增长最快的开源 TTS 项目之一。

| 指标 | VoxCPM 0.5B | VoxCPM 1.5（旧版） | **VoxCPM2 ⭐ 2026-04** |
|------|-------------|-------------------|------------------------|
| **发布时间** | 2025年9月 | 2025年12月 | **2026年4月（🔥今日确认）** |
| **参数量** | 5亿（0.5B） | 15亿（1.5B） | **20亿（2B）** |
| **训练数据** | 180万小时 | 180万小时+ | **200万小时** |
| **音频采样率** | 44.1kHz CD级 | 48kHz | **48kHz 工作室级** |
| **克隆方式** | LocDiT 扩散零样本 | LocDiT 扩散增强 | **LocDiT扩散 + 终极克隆（高保真重放）** |
| **最低样本** | 10-30秒 | 5-10秒 | **3-10秒（可控克隆）** |
| **中国方言** | 未明确 | 未明确 | **9种（四川/粤语/吴语/东北/河南/陕西/山东/天津/闽南）** |
| **推理速度（RTF）** | 0.17（消费级GPU） | 更快 | **~0.30（标准）/ NanoVLLM ~0.13** |
| **支持语言** | 30+ | 30+ | **30种** |
| **开源协议** | **Apache 2.0** | **Apache 2.0** | **Apache 2.0（可商用）** |
| **GitHub** | [OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) | 同上 | **9.9k Stars 🔥** |
| **HuggingFace** | [openbmb/VoxCPM-0.5B](https://huggingface.co/openbmb/VoxCPM-0.5B) | 待更新 | **[openbmb/VoxCPM2](https://huggingface.co/openbmb/VoxCPM2)** |
| **最新版本** | - | - | **v2.0.2（2026-04-08，修复bug）** |
